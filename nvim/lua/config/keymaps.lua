...
keymap.set("n", "<C-h>", "<C-w>h", non_recursive_option)
keymap.set("n", "<C-j>", "<C-w>j", non_recursive_option)
keymap.set("n", "<C-k>", "<C-w>k", non_recursive_option)
keymap.set("n", "<C-l>", "<C-w>l", non_recursive_option)
